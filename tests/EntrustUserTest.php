...
use Arvindkumar\EntrustMongoDB\Contracts\EntrustUserInterface;
use Arvindkumar\EntrustMongoDB\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use Arvindkumar\EntrustMongoDB\Permission;
use Arvindkumar\EntrustMongoDB\Role;
use Mockery as m;
...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $permMock = m::mock('Arvindkumar\EntrustMongoDB\Permission');
    ...
    {
        $roleMock = m::mock('Arvindkumar\EntrustMongoDB\Role');
